...
export class TideProvider extends Resource<{ realm?: string }> {
  ...
  /* # TIDECLOAK IMPLEMENTATION */
  public triggerScheduledTask = this.makeRequest<
    { taskName: string },
    Response
  >({
    method: "POST",
  ...
  /* # TIDECLOAK IMPLEMENTATION */
  public createCustomerPortalSession = this.makeRequest<
    FormData,
    stripeCheckoutSessionResponse
  >({
    method: "POST",
  ...
  /* # TIDECLOAK IMPLEMENTATION */
  public triggerVendorKeyCreationEvent = this.makeRequest<
    { error: boolean },
    void
  >({
    method: "GET",
  ...
  /* # TIDECLOAK IMPLEMENTATION */
  public triggerAuthorizerUpdateEvent = this.makeRequest<
    { error: boolean },
    void
  >({
    method: "GET",
